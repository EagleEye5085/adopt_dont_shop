...
pet_3 = Pet.create(adoptable: false, age: 2, breed: 'saint bernard', name: 'Beethoven')
pet_4 = Pet.create(adoptable: false, age: 3, breed: 'Whippet', name: 'Annabelle')
pet_5 = Pet.create(adoptable: true, age: 3, breed: 'GSD', name: 'Charlie')
